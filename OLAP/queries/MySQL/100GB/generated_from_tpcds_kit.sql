...
where 
	...
	and d_date between cast('1998-04-06' as date) 
				and date_add(cast('1998-04-06' as date), interval 30 day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with  cross_items as
 ...
 where ws_item_sk = iws.i_item_sk
   ...
   and d3.d_year between 2000 AND 2000 + 2)) t1
...
select  i_item_id
 ...
 and d_date between cast('2002-01-26' as date) 
 				and date_add(cast('2002-01-26' as date), interval 30 day)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between date_sub(cast('2002-02-27' as date), interval 30 day)
                    and date_add(cast('2002-02-27' as date), interval 30 day)
...
select  i_item_id
 ...
 and d_date between cast('1999-02-21' as date) and date_add(cast('1999-02-21' as date), interval 60 day)
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between date_sub(cast('2001-04-02' as date), interval 30 day)
                and date_add(cast('2001-04-02' as date), interval 30 day)
 group by
    w_state,i_item_id
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-05' as date) 
                  and date_add(cast('1998-08-05' as date), interval 30 day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-28' as date) 
                  and date_add(cast('1998-08-28' as date), interval 30 day)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-07-09' as date) and date_add(cast('1999-07-09' as date), interval 60 day)
...
from ((select distinct c_last_name, c_first_name, d_date
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
         and store_sales.ss_customer_sk = customer.c_customer_sk
         and d_month_seq between 1184 and 1184+11 AND NOT EXISTS
      (select distinct c_last_name, c_first_name, d_date
       from catalog_sales, date_dim, customer
       where catalog_sales.cs_sold_date_sk = date_dim.d_date_sk
         and catalog_sales.cs_bill_customer_sk = customer.c_customer_sk
...
and d_date between '2002-02-26' and 
        date_add(cast('2002-02-26' as date), interval 90 day)
...
where
	...
	date_add(cast('2000-2-01' as date), interval 60 day)
...
where 
	...
	and d_date between cast('2002-05-20' as date) 
				and date_add(cast('2002-05-20' as date), interval 30 day)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
